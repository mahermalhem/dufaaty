...
class FCMService {
  ...
  registerAppWithFCM = async() => {
    if (Platform.OS === "ios") {
      //Warning : Usage of "messaging().registerDeviceForRemoteMessages()" is not required. You only need to register if auto-registration is disabled in your 'firebase.json' configuration file via the 'messaging_ios_auto_register_for_remote_messages' property. 
